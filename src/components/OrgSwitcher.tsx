...
export function OrgSwitcher() {
  ...
  return (
    <select
      ...
      className="max-w-[160px] rounded-md border border-gray-300 bg-white px-2.5 py-1.5 text-sm font-medium text-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-500 sm:max-w-none"
